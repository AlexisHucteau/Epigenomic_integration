...
write.csv(Gene_stress_auto_hypermeth_TCGA, file = "../Results/Gene_stress_metabo_hypermeth_TCGA.csv", row.names = FALSE)
```
...
Koichi_T.test_analysis <- T_test_on_methylation_promoter(BMIQ_Wang_Feng, match_hit_CpGs_Blueprint_promoter_EPIC, Phenotype_Wang_Feng, c("Non_Responder", "Responder"))
